...
class PaderbornData:
    ...
    def __init__(self, root_dir, experiment='', datastream='vibration',
                 normalisation='robust-zscore'):
        experiments = ['artificial', 'real']
    ...
    def split_data(self, data_length, train_fraction=0.5, 
                   window_length=2048, window_step=64, verbose=False):        
        ...
        for f in file_iter:
            try:
              ...
              if len(x_train) != len(y_train):
                ...
                raise Exception("Error: Training shapes do not match")
                sys.exit(0)
